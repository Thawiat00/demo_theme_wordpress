...
function wp_theme_register_script() {
	 ...
	 */
	wp_enqueue_style('wp-vendor_mix', get_theme_file_uri('/css/vendor/vendor.css'), array(), '1.0.0');
	...
	wp_register_script('wp-vendor-mix', get_theme_file_uri('/js/vendor/vendor.js'), array('jquery'), '1.0.0', true);
	...
	wp_enqueue_script('wp-vendor-mix');
